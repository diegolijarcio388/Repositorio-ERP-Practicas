...
var getDeviceTypeLabel = (deviceType) => deviceType ? DEVICE_TYPE_LABELS[deviceType] : "Dispositivo";
...
var getStartOfWeekSqlDate = (sqlDate) => {
  const date = /* @__PURE__ */ new Date(`${sqlDate}T12:00:00`);
  const day = date.getDay();
  const diffToMonday = day === 0 ? -6 : 1 - day;
  date.setDate(date.getDate() + diffToMonday);
  return date.toISOString().slice(0, 10);
};
var getEndOfWeekSqlDate = (sqlDate) => {
  const start = /* @__PURE__ */ new Date(`${getStartOfWeekSqlDate(sqlDate)}T12:00:00`);
...
function TimeControlFeature({
  ...
  const [incidentRangeFilter, setIncidentRangeFilter] = (0, import_react4.useState)("day");
  ...
  const workerCalendarScrollRef = (0, import_react5.useRef)(null);
  const workerCalendarTouchStartXRef = (0, import_react5.useRef)(null);
  const workerCalendarTouchScrollLeftRef = (0, import_react5.useRef)(0);
  ...
  const incidentWeekRange = (0, import_react4.useMemo)(
    () => ({
  ...
  const filteredManagerIncidentRecords = (0, import_react4.useMemo)(
    () => managerIncidentRecords.filter((record) => {
      const matchesBaseRange = incidentRangeFilter === "week" ? record.workDate >= incidentWeekRange.from && record.workDate <= incidentWeekRange.to : record.workDate === trackerDate;
      if (!matchesBaseRange) {
        return false;
      }
  ...
  const modalManagerIncidentRecords = (0, import_react4.useMemo)(
    () => managerIncidentRecords.filter(
      (record) => incidentRangeFilter === "week" ? record.workDate >= incidentWeekRange.from && record.workDate <= incidentWeekRange.to : record.workDate === trackerDate
    ),
    [
      incidentRangeFilter,
      incidentWeekRange.from,
  ...
  const renderQuickActionsCard = (layout = "desktop") => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: wrapperClass, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: "mb-3 px-1 text-xs font-bold uppercase tracking-wider text-slate-400", children: "Acciones r\xE1pidas" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex flex-col gap-3", children: [
        isWorkerMode && (!openRecord ? (
          /* Estado: Iniciar Jornada */
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center justify-between rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-all duration-200 hover:border-slate-200/80 hover:shadow-md", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "flex-1 space-y-0.5 pr-4", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { className: "text-sm font-semibold text-slate-900", children: "Iniciar Jornada" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                ...
                disabled: submitting,
                children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("svg", { className: "ml-0.5 h-4 w-4 fill-current", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M8 5v14l11-7z" }) })
              }
            )
          ] })
        ) : (
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center justify-between rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-all duration-200 hover:border-slate-200/80 hover:shadow-md", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "flex-1 space-y-0.5 pr-4", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { className: "text-sm font-semibold text-rose-700", children: "Finalizar Jornada" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                ...
                disabled: submitting,
                children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("svg", { className: "h-3.5 w-3.5 fill-current", viewBox: "0 0 24 24", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("path", { d: "M6 6h12v12H6z" }) })
              }
            )
          ] })
        )),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center justify-between rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-all duration-200 hover:border-slate-200/80 hover:shadow-md", children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "flex-1 space-y-0.5 pr-4", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { className: "text-sm font-semibold text-slate-900", children: "Solicitar Fichaje" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            "button",
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("i", { className: "ti ti-edit text-[18px]", "aria-hidden": "true" })
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center justify-between rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-all duration-200 hover:border-slate-200/80 hover:shadow-md", children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "flex-1 space-y-0.5 pr-4", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { className: "text-sm font-semibold text-slate-900", children: "Ayuda Ubicaci\xF3n" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
            "button",
            {
              ...
              disabled: submitting,
              children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("i", { className: "ti ti-map-pin text-[18px]", "aria-hidden": "true" })
            }
          )
        ] })
      ] })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "rounded-xl border border-emerald-100 bg-emerald-50/40 px-4 py-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "rounded bg-white px-2 py-0.5 text-[11px] font-bold text-slate-500", children: getDeviceTypeLabel(record.checkInDeviceType) })
              ] }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "rounded-xl border border-rose-100 bg-rose-50/30 px-4 py-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex flex-wrap items-center justify-between gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center gap-2", children: [
                ...
                record.checkOutAt ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "rounded bg-white px-2 py-0.5 text-[11px] font-bold text-slate-500", children: getDeviceTypeLabel(record.checkOutDeviceType) }) : null
              ] }),
  ...
  const handleWorkerCalendarTouchStart = (event) => {
  ...
  const handleWorkerCalendarTouchMove = (event) => {
    const container = workerCalendarScrollRef.current;
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex-1 min-w-0 space-y-4 overflow-visible", children: [
          headerSlot ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "relative", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "min-w-0", children: headerSlot }),
                  ...
                  loading ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: "text-sm text-slate-500", children: "Cargando registros..." }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "space-y-4", children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "min-w-[600px] lg:min-w-full space-y-3", children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "space-y-8", children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "space-y-4", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center gap-3", children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("h4", { className: "text-sm font-bold uppercase tracking-wider text-slate-700", children: [
                            isCoordinatorManagerView ? incidentRangeFilter === "week" ? "Registros horarios con incidencia de la semana (" : "Registros horarios con incidencia (" : incidentRangeFilter === "week" ? "Fichajes con incidencia de la semana (" : "Fichajes con incidencia (",
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex items-center gap-2", children: [
                          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                            "button",
                            {
                              ...
                              className: `rounded-full px-3 py-1.5 text-xs font-semibold transition-all ${incidentRangeFilter === "day" ? "bg-slate-900 text-white shadow-sm" : "border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:text-slate-900"}`,
                              children: "Hoy"
                            }
                          ),
                          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
                            "button",
                            {
                              ...
                              className: `rounded-full px-3 py-1.5 text-xs font-semibold transition-all ${incidentRangeFilter === "week" ? "bg-slate-900 text-white shadow-sm" : "border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 hover:text-slate-900"}`,
                              children: "Semana"
                            }
                          ),
                          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "text-xs text-slate-500", children: incidentRangeFilter === "week" ? `${formatShortDate(incidentWeekRange.from)} - ${formatShortDate(incidentWeekRange.to)}` : formatShortDate(trackerDate) })
                        ] }),
    ...
    showManagerIncidentsModal ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "fixed inset-0 z-40 flex items-center justify-center bg-slate-950/45 px-4", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "w-full max-w-3xl rounded-2xl border border-slate-200 bg-white shadow-2xl", children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "flex flex-wrap items-start justify-between gap-4 border-b border-slate-100 px-5 py-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: "mt-0.5 text-base font-semibold text-slate-900 tracking-tight", children: incidentRangeFilter === "week" ? "Registros con anomal\xEDas de la semana" : "Registros con anomal\xEDas" }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "mt-2 flex items-center gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "mt-2 flex flex-wrap gap-2", children: [
            modalManagerIncidentRecords.filter((r) => r.status === "INCIDENT").length > 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { className: "inline-flex items-center gap-1.5 rounded-full border border-rose-200 bg-rose-50 px-2.5 py-1 text-xs font-medium text-rose-700", children: [
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "h-1.5 w-1.5 rounded-full bg-rose-500" }),
              modalManagerIncidentRecords.filter((r) => r.status === "INCIDENT").length,
              " incidencia",
              modalManagerIncidentRecords.filter((r) => r.status === "INCIDENT").length !== 1 ? "s" : ""
            ] }),
            modalManagerIncidentRecords.filter((r) => r.status === "INCOMPLETE").length > 0 && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { className: "inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-xs font-medium text-slate-600", children: [
              /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "h-1.5 w-1.5 rounded-full bg-slate-400" }),
              modalManagerIncidentRecords.filter((r) => r.status === "INCOMPLETE").length,
              " incompleta",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "max-h-[60vh] overflow-y-auto px-5 py-4", children: modalManagerIncidentRecords.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { className: "text-sm text-slate-500 text-center py-4", children: "No hay incidencias en el conjunto filtrado actualmente." }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "space-y-2", children: modalManagerIncidentRecords.map((record) => /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        "div",
        {
